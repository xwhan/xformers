...
class BlockWiseAttention(Attention):
    ...
    def forward(
        ...
        *args, **kwargs
        ...
        outputs = win_attn_probs.matmul(V_tiles).view(batch_size, self.num_head, seq_len, self.head_dim)
    ...
    #         outputs += global_attn_probs.matmul(selected_v.transpose(1,2))
    ...
    #         outputs[extra_attention_mask_nonzeros[0],:,extra_attention_mask_nonzeros[1]] = nonzero_global_attn
